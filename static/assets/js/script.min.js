        ...
        e(".vInputImage").change(function (t) {
            ...
            if (n) {
                ...
                (i.onload = function () {
                    ...
                    i.readAsDataURL(n),
                    a.find("button").removeClass("d-none"),
                    a.trigger("ip.img.change", [n, a.attr("input-data-index")]);
            }
        }),
            e(".vClearPreviewImage").click(function (t) {
                let n = e(this).parent();
                t.currentTarget.classList.add("d-none"),
                    n.css(
                        "background-image",
                        "url('/input_image_preview/upload_image.png')"
                    ),
                    n.find("input").val(null),
                    n.trigger("ip.img.clear", [n.attr("input-data-index")]);
            });
    })(jQuery),
